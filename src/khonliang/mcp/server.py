    ...
    def _coding_guide_sections() -> Dict[str, str]:
        return {
            "workflow": (
                ...
                "\n"
                "  1. Issue — start from a tracked task, bug, or feature request\n"
                "     Confirm scope and review any existing project guidance first.\n"
                "  2. Plan — document the approach in the repository's documented\n"
                "     contribution or design workflow when required.\n"
                "  3. Branch — create an isolated branch for the change\n"
                "     Follow the repository's documented branching conventions.\n"
                "  4. Code — implement with a review loop at each step\n"
                "     Write code, run tests, get review, and iterate.\n"
                "  5. Code review — respond to all review comments\n"
                "     Resolve every conversation before proceeding.\n"
                "  6. PR — open a pull request against the appropriate base branch\n"
                "     Use the repository's PR template and reviewer process if present.\n"
                "  7. PR review — respond to PR review feedback\n"
                "     Iterate until approved.\n"
                "  8. Merge — merge using the repository's documented process\n"
                "     Update any required issue, changelog, or release tracking records.\n"
                "\n"
                "Key rules:\n"
                "  - Plan first; don't start coding without agreed scope.\n"
                "  - Keep changes aligned with the repository's documented workflow.\n"
            ...
            "reviews": (
                ...
                "  After the first commit, add a PR comment:\n"
                "    @copilot please review this PR, I did the following:\n"
                "    - <summary of changes>\n"
                "  Must be a comment (not the PR description) to trigger review.\n"
                "\n"
                "## PR review\n"
